...
#| echo: true
#| label: fig-scatter
#| fig-cap: "Scatter plot of the collider data in the X1 and X2 feature space, with points colour-coded by true particle class (α in red, β in blue, ρ in green), illustrating substantial overlap and non-linear boundaries that motivate using a neural network for classification."
...
ggplot(dat, aes(x=X1, y=X2, color=response ))+geom_point(size=2)+ ggtitle("Scatter plot of Collider Data Feature Space") + theme_minimal() +  theme(aspect.ratio = 1) 
