...
```{r, warning=FALSE, message=FALSE, fig.cap="This is a scatterplot of particle coordinates on the feature space (X1-X2 plane), colored by true particle type."}
#| echo: true
#| label: fig-dat
dat$response <- apply(dat[, c("Y1", "Y2", "Y3")], 1, function (x){ # naming the responses
